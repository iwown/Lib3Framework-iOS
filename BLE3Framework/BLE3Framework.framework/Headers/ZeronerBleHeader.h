...
typedef enum {
    ...
    CMD_ID_DATALOG_SCALE_SYSC_INFO = CMD_ID_DATALOG_START_GET_DAY_DATA,
    CMD_ID_DATALOG_STOP_GET_DAY_DATA = 4,
    CMD_ID_DATALOG_SCALE_SYSC_DATA = CMD_ID_DATALOG_STOP_GET_DAY_DATA,
    CMD_ID_DATALOG_START_GET_MINUTE_DATA = 5,
    CMD_ID_DATALOG_SCALE_SYSC_DATA_RECENT = CMD_ID_DATALOG_START_GET_MINUTE_DATA,
